...
function HomeSection(){
    ...
    return(
        <div id="home" className="h-[80vh] md:h-[100vh] w-full flex items-center justify-center flex-col gap-12 lg:gap-14 text-center px-4 relative" style={{backgroundImage:`url(${homeimage})`}}>
