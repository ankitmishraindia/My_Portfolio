...
function AboutSection(){
  ...
  const scrollToSection = (id) => {
    ...
    return(
        <div id="about" className=" w-full h-fit px-10 md:px-5 lg:px-16 py-7 lg:py-20 flex flex-col items-center justify-evenly lg:justify-around ">
            ...
            <div className="flex justify-between">
                    <div className="space-y-8 lg:space-y-7 lg:w-[40%]">
                        <h3 className="text-2xl lg:text-3xl font-bold">Get to know me!</h3>
                        <div className="space-y-3 lg:space-y-6 lg:text-xl">
                            <p>I&apos;m a <b>Web Developer</b> building the Front-end & Backend of Websites and Web Applications that leads to the success of the overall product. Check out some of my work in the <b>Projects</b> section.</p>
                            <p className="">I also like sharing content related to the stuff that I have learned over the years in <b>Web Development</b> so it can help other people of the Dev Community. Feel free to Connect or Follow me on my <a className="text-yellow-500 underline hover:text-yellow-600 font-bold" href="https://www.linkedin.com/in/ankit-mishra-537217115/">Linkedin</a> and <a className="text-yellow-500 underline hover:text-yellow-600 font-bold" href="https://ankitmishraindia.hashnode.dev/">Hashnode</a> where I post useful content related to Web Development and Programming.</p>
